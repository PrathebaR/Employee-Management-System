...
- Step:4 At last using PhpMyAdmin just import the **(ems.sql)** file and start your CRUD operation (And then don't forget to alter the table name in the server/index.js file)